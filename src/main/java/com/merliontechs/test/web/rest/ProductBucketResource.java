package com.merliontechs.test.web.rest;

import com.merliontechs.test.domain.ProductBucket;
import com.merliontechs.test.repository.ProductBucketRepository;
import com.merliontechs.test.web.rest.errors.BadRequestAlertException;
...
/**
 * REST controller for managing {@link com.merliontechs.test.domain.ProductBucket}.
 */
@RestController
@RequestMapping("/api")
@Transactional
