...
import com.merliontechs.test.domain.Product;
import com.merliontechs.test.repository.ProductRepository;
...
/**
 * REST controller for managing {@link com.merliontechs.test.domain.Product}.
 */
@RestController
@RequestMapping("/api")
@Transactional
